 ...
 */
 ...
 public class Bank {
     ...
     public void addAccount() {
         ...
         if(bal <= 20){                          //increment of low balance accounts
            lowBalance++;
            newAcct = new Account(bal, fName, lName, true);
         } else {
            newAcct = new Account(bal, fName, lName, false);
         }
         ...
         System.out.println("# of Low Balance Accounts: " + lowBalance);
     }
